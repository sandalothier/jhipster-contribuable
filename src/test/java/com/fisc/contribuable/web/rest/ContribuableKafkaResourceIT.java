...
import com.fisc.contribuable.service.ContribuableKafkaProducer;
import com.fisc.contribuable.service.ContribuableKafkaConsumer;
...
public class ContribuableKafkaResourceIT {
    ...
    @Autowired
    private ContribuableKafkaProducer producer;

    @Autowired
    private ContribuableKafkaConsumer consumer;
    ...
    @BeforeEach
    public void setup() {
        ContribuableKafkaResource kafkaResource = new ContribuableKafkaResource(producer);
    ...
    public void producedMessageHasBeenConsumed() throws Exception {
        restMockMvc.perform(post("/api/contribuable-kafka/publish?message=test"))
